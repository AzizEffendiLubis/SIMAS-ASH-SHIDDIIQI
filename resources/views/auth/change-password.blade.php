...
<div class="card">
    ...
    {{-- Logo dalam card — identik dengan login --}}
    <div class="logo">
    ...
    <div class="alert alert-error">
        <i class="fas fa-circle-xmark"></i> {{ $errors->first('password') }}
    </div>
    @endif

    {{-- Form — POST /password/change → password.change.post --}}
