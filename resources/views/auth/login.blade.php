...
<body>
    <div class="card">
        ...
        {{-- Logo --}}
        <div class="logo">
            <img src="{{ asset('images/10505884-5.jpg') }}" alt="Logo SIMAS" class="logo-img">
            <h1>SIMAS</h1>
        ...
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <div class="form-group">
                ...
                @error('username')
                    <p class="error-msg"><i class="fas fa-circle-xmark"></i> {{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    {{-- Tombol toggle ada di dalam kotak input --}}
            ...
            <div class="remember-row">
                ...
                {{--
                    Tidak ada link "Lupa Password".
                    Dokumen: "Forgot password tidak tersedia — Admin Utama mereset
                    password pengguna melalui halaman manajemen pengguna."
                --}}
            </div>
        ...
        {{--
            ...
            Dokumen: "Fitur registrasi pengguna tidak diperlukan karena seluruh
            akun akan dibuat langsung oleh admin utama."
        --}}
        <div class="note">
