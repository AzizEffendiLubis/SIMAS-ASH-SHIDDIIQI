            ...
            <div class="form-group full">
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" name="name" placeholder="Nama lengkap Anda"
                        value="<?php echo e(old('name')); ?>" class="<?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" name="email" placeholder="email@domain.com"
                        value="<?php echo e(old('email')); ?>" class="<?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>">
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" name="phone" placeholder="08xxxxxxxxxx" value="<?php echo e(old('phone')); ?>">
                </div>
            </div>
        </div>
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <select name="jabatan" class="<?php echo e($errors->has('jabatan') ? 'is-invalid' : ''); ?>">
                        <option value="">-- Pilih Jabatan --</option>
                        <?php $__currentLoopData = ['Guru','Staff','Petugas Kebersihan','Petugas Keamanan','Santri','Lainnya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <select name="unit_kerja" class="<?php echo e($errors->has('unit_kerja') ? 'is-invalid' : ''); ?>">
                        <option value="">-- Pilih Unit --</option>
                        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($unit); ?>" <?php echo e(old('unit_kerja') == $unit ? 'selected' : ''); ?>><?php echo e($unit); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            ...
            <div class="form-group full">
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" name="username" placeholder="Masukkan username"
                        value="<?php echo e(old('username')); ?>" class="<?php echo e($errors->has('username') ? 'is-invalid' : ''); ?>">
                </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="terms-row">
            <input type="checkbox" name="terms" id="terms" value="1" <?php echo e(old('terms') ? 'checked' : ''); ?>>
            <label for="terms">
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="error-msg" style="margin-bottom:10px;"><?php echo e($message); ?></p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
    ...
    <p class="login-link">Sudah punya akun? <a href="<?php echo e(route('login')); ?>">Masuk di sini</a></p>
</div>
...
<?php /**PATH C:\Users\Acer0\Ash-Shidddiqi\resources\views/auth/register.blade.php ENDPATH**/ ?>